            ...
            <View style={styles.wrapper}>
                <View style={styles.top}>
                    ...
                    onPress={()=>this.props.navigation.pop()}>
                        <Image style={styles.imagetop} source={require('../../../images/back.png')}/>
                    </TouchableOpacity>
                    <View style={{}}> 
                        <Text style={styles.texttop}>Market Online</Text>
                    </View>
                    <Image style={styles.imagetop} source={require('../../../images/icon.png')} />
                </View>
                {main}
                <View style={styles.control}>
                    <TouchableOpacity onPress={()=>{this.SignIn()}} style={styles.signin}>
                        <Text style={isSigin?styles.textin:styles.textup}>ĐĂNG NHẬP</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={()=>{this.SignUp()}} style={styles.signup}>
                        <Text style={!isSigin?styles.textin:styles.textup}>ĐĂNG KÝ</Text>
                    </TouchableOpacity>
                </View>
            </View>
        )
