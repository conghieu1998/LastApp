            ...
            <View style={{justifyContent:'space-around',backgroundColor:'salmon'}}>
                <View style={styles.top}>
                    <TouchableOpacity onPress={this.props.onOpen1}>
                        <Image style={styles.imagetop} source={require('../../../images/icon-menu.png')}/>
                    </TouchableOpacity>
                    <View style={{}}> 
                    ...
                    <View style={styles.viewinput}>
                        <TextInput maxLength={50} style={styles.input} placeholder='Bạn cần mua gì cho hôm nay' placeholderTextColor={'black'} />
                    </View>
            </View>
        )
    }
