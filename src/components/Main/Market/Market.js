    ...
    render() {
        ...
        return (
            <View style={{flex:1}}>
                ...
                <TabNavigator.Item titleStyle={{fontSize:15}}
                    selected={selectedTab === 'home'}
                    title="Khám phá"
                    renderIcon={() => <Image style={styles.image} source={require('../../../../images/khampha.png')} />}
                    renderSelectedIcon={() => <Image style={styles.image} source={require('../../../../images/khampha-select.png')} />}
                ...
                <TabNavigator.Item titleStyle={{fontSize:15}}
                    ...
                    title="Cửa hàng"
                    renderIcon={() => <Image style={styles.image} source={require('../../../../images/store.png')} />}
                    renderSelectedIcon={() => <Image style={styles.image} source={require('../../../../images/store-select.png')} />}
                ...
                <TabNavigator.Item titleStyle={{fontSize:15}}
                    ...
                    title="Ngành hàng"
                    renderIcon={() => <Image style={styles.image} source={require('../../../../images/fish.png')} />}
                    renderSelectedIcon={() => <Image style={styles.image} source={require('../../../../images/fish-select.png')} />}
                ...
                <TabNavigator.Item titleStyle={{fontSize:15}}
                    ...
                    renderSelectedIcon={() => <Image source={require('../../../../images/cart-select.png')} />}
                    badgeText="1"
                ...
                <TabNavigator.Item titleStyle={{fontSize:15}}
                    ...
                    title="Tài khoản"
                    renderIcon={() => <Image style={styles.image} source={require('../../../../images/user.png')} />}
                    renderSelectedIcon={() => <Image source={require('../../../../images/user-select.png')} />}
